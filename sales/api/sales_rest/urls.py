...
from .views import api_customer_list, api_salesperson_list, api_sales_record_list, api_automobile_list, api_employee_sales_record
...
urlpatterns = [
  ...
  path('salesrecords/<int:id>/', api_employee_sales_record, name="api_employee_sales_record")
]
